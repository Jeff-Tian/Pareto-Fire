...
import CitiProducts from '../components/citi/CitiProducts'
...
export default class Settings extends React.Component {
  ...
  async componentDidMount() {
    ...
    await this.loadCitiAccountInfo(user.id)
  }
  ...
  async loadCitiAccountInfo(userId) {
    await fetch(`/.netlify/functions/load-citi-account-info?userId=${userId}`)
  }
  ...
  render() {
    return <Item.Group>
      ...
      {
        this.state.user && !this.state.user.citiAccount &&
        <CitiProducts/>
      }
    </Item.Group>
  }
